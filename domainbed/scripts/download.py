...
def download_histopantume(data_dir):
    # Original URL: http://hemanthdv.org/OfficeHome-Dataset/
    full_path = stage_path(data_dir, "histopantume")

    download_and_extract("https://zenodo.org/records/14555794/files/colon.tar.gz?download=1", os.path.join(full_path, "colon.tar.gz"))
    download_and_extract("https://zenodo.org/records/14555794/files/ovarian.tar.gz?download=1", os.path.join(full_path, "ovarian.tar.gz"))
    download_and_extract("https://zenodo.org/records/14555794/files/stomach.tar.gz?download=1", os.path.join(full_path, "stomach.tar.gz"))
    download_and_extract("https://zenodo.org/records/14555794/files/uterus.tar.gz?download=1", os.path.join(full_path, "uterus.tar.gz"))
